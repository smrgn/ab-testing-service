...
from app.experiment_manage_screen import render_experiment_management_screen
...
menu = st.sidebar.radio("Меню", [
    ...
    "ℹ️ FAQ"
], index=["🏠 Главная", "🪄 Управление экспериментами", "📐 Дизайн эксперимента", "✅ Валидация метрик", "📊 Анализ результатов", "📚 История экспериментов", "ℹ️ FAQ"].index(st.session_state.menu))
...
if menu == "🏠 Главная":
    render_home_screen()
elif menu == "🪄 Управление экспериментами":
    render_experiment_management_screen()
